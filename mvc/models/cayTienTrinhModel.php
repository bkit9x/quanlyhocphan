...
class cayTienTrinhModel extends DB
{
    ...
    public function them()
    {
        if (isset($_POST['tencaytientrinh']) && isset($_POST['tenkhoa'])) {
            ...
            if ($result)
                header("Location: ".DOMAIN."caytientrinh/index&msg=themthanhcong");
            else
                header("Location: ".DOMAIN."caytientrinh/index&msg=themloi");
        }
    }
    ...
    public function sua()
    {
        if (isset($_POST['sua_idcaytientrinh']) && isset($_POST['sua_tencaytientrinh']) && isset($_POST['sua_tenkhoa'])) {
            ...
            if ($result)
                header("Location: ".DOMAIN."caytientrinh/index&msg=suathanhcong");
            else
                header("Location: ".DOMAIN."caytientrinh/index&msg=sualoi");
        }
    }
    ...
    public function xoa()
    {
        if (isset($_POST['xoa_idcaytientrinh'])) {
            ...
            if ($result)
                header("Location: ".DOMAIN."caytientrinh/index&msg=xoathanhcong");
            else
                header("Location: ".DOMAIN."caytientrinh/index&msg=xoaloi");
        }
    }
}
