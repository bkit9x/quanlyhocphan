...
class chiTietModel extends DB
{
    ...
    public function them(){
        if (isset($_POST['mahocphan']))
        {
            ...
            if ($result)
                header("Location: /index.php?url=chitiet/index&msg=themthanhcong&id=".$idcaytientrinh);
            else
                header("Location: /index.php?url=chitiet/index&msg=themloi&id=".$idcaytientrinh);
        }
    }
    ...
    public function xoa(){
        if (isset($_POST['xoa_mahocphan']))
        {
            ...
            if ($result)
                header("Location: /index.php?url=chitiet/index&msg=xoathanhcong&id=".$idcaytientrinh);
            else
                header("Location: /index.php?url=chitiet/index&msg=xoaloi&id=".$idcaytientrinh);
        }
    }
