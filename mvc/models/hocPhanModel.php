...
class hocPhanModel extends DB
{
    ...
    public function them()
    {
        if (isset($_POST['mahocphan']) && isset($_POST['tenhocphan']) && isset($_POST['sotinchi']) && isset($_POST['hocphantienquyet'])) {
            ...
            if ($result)
                header("Location: " . DOMAIN . "hocphan/index&msg=themthanhcong");
        } else
            header("Location: " . DOMAIN . "hocphan/index&msg=themloi");
    }
    ...
    public function sua()
    {
        if (isset($_POST['sua_mahocphan']) && isset($_POST['sua_mahocphan_old']) && isset($_POST['sua_tenhocphan']) && isset($_POST['sua_sotinchi'])) {
            ...
            if ($result)
                header("Location: " . DOMAIN . "hocphan/index&msg=suathanhcong");
            else
                header("Location: " . DOMAIN . "hocphan/index&msg=sualoi");
        }
    }
    ...
    public function xoa()
    {
        if (isset($_POST['xoa_mahocphan'])) {
            ...
            if ($result)
                header("Location: " . DOMAIN . "hocphan/index&msg=xoathanhcong");
            else
                header("Location: " . DOMAIN . "hocphan/index&msg=xoaloi");
        }
    }
}
