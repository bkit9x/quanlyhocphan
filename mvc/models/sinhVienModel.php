    ...
    public function sua()
    {
        if (isset($_POST['sua_idsinhvien']) && isset($_POST['sua_idcaytientrinh'])) {
            ...
            if (isset($_POST['sua_idcaytientrinh_old']) && $_POST['sua_idcaytientrinh_old'] != '') {
                ...
                $sql = "UPDATE `caytientrinhsinhvien` SET `idcaytientrinh` = '$idcaytientrinh' WHERE `idcaytientrinh` = '$idcaytientrinh_old' AND  `idsinhvien` = '$idsinhvien'";
            } else {
                $sql = "INSERT INTO `caytientrinhsinhvien` (`idsinhvien`, `idcaytientrinh`) VALUES ('$idsinhvien', '$idcaytientrinh')";
            }
