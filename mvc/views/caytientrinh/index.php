        <div class="box box-default">
            <div class="box-header">
                <h3 class="box-title">Danh sách cây tiến trình</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table id="table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php foreach ($data['list'] as $caytientrinh): ?>
                            <tr>
                                <td><?= $caytientrinh['idcaytientrinh'];?></td>
                                <td><?= $caytientrinh['tencaytientrinh'];?></td>
                                <td><?= $caytientrinh['tenkhoa'];?></td>
                                <td><a href="./index.php?url=chitiet/index&id=<?= $caytientrinh['idcaytientrinh'];?>" class="btn btn-success btn-sm mr-2"><i class="fa fa-mail-forward"></i> Xem chi tiết</a> <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" id="btn-modal-sua" data-idcaytientrinh="<?= $caytientrinh['idcaytientrinh'];?>" data-tencaytientrinh="<?= $caytientrinh['tencaytientrinh'];?>" data-tenkhoa="<?= $caytientrinh['tenkhoa'];?>" data-target="#modal-sua"> <i class="fa fa-pencil-square-o"></i> Sửa</button> <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" id="btn-modal-xoa" data-xoa_idcaytientrinh="<?= $caytientrinh['idcaytientrinh'];?>"  data-xoa_tencaytientrinh="<?= $caytientrinh['tencaytientrinh'];?>"  data-target="#modal-xoa"> <i class="fa fa-trash-o"></i> Xóa</button></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                    <tfoot>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_them" role="form" method="post" action="./index.php?url=caytientrinh/them">
        ...
        <div class="modal fade" id="modal-sua">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_sua" role="form" method="post" action="./index.php?url=caytientrinh/sua">
                            <div class="form-group">
                                <label>Tên cây tiến trình</label>
        ...
        <div class="modal fade" id="modal-xoa">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="frm_xoa" role="form" method="post" action="./index.php?url=caytientrinh/xoa">
                            <div class="form-group">
