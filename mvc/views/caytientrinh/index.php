            ...
            <tbody>
                <?php foreach ($data['list'] as $caytientrinh) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= DOMAIN ?>chitiet/index&id=<?= $caytientrinh['idcaytientrinh']; ?>" class="btn btn-success btn-sm mr-2" target="_blank">
                                <i class="fa fa-mail-forward"></i> Xem chi tiết
                            </a>
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" id="btn-modal-sua" data-idcaytientrinh="<?= $caytientrinh['idcaytientrinh']; ?>" data-tencaytientrinh="<?= $caytientrinh['tencaytientrinh']; ?>" data-tenkhoa="<?= $caytientrinh['tenkhoa']; ?>" data-target="#modal-sua">
                                <i class="fa fa-pencil-square-o"></i> Sửa
                            </button>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" id="btn-modal-xoa" data-xoa_idcaytientrinh="<?= $caytientrinh['idcaytientrinh']; ?>" data-xoa_tencaytientrinh="<?= $caytientrinh['tencaytientrinh']; ?>" data-target="#modal-xoa">
