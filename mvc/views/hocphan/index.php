    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frm_them" role="form" method="post" action="<?= DOMAIN ?>hocphan/them">
...
<div class="modal fade" id="modal-sua">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frm_sua" role="form" method="post" action="<?= DOMAIN ?>hocphan/sua">
                    <div class="form-group">
                        <label>Mã học phần</label>
...
<div class="modal fade" id="modal-xoa">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frm_xoa" role="form" method="post" action="<?= DOMAIN ?>hocphan/xoa">
                    <div class="form-group">
                        <label>Mã học phần</label>
